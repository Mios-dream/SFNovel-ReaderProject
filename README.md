...
**软件支持 Windows 平台和 Android 平台。**

> [!IMPORTANT]
> 当前主要api以网页凭证优先，使用ocr识别正文。规避了风控风险。
...
<table>
  ...
  <tr>
    <td><img style="width: 100%;" src="./docs/image/app小说详情.png" alt="app小说详情"></td>
    <td><img style="width: 100%;" src="./docs/image/app播放器.png" alt="app有声播放器"></td>
  </tr>
</table>
